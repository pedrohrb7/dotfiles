---
name: react-native-testing-v14-api
description: Complete RNTL v14.x API reference (React 19+) — async render, await-based APIs, removed APIs, v13 to v14 migration codemods.
---

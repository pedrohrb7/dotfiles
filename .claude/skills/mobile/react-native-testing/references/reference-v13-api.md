---
name: react-native-testing-v13-api
description: Complete RNTL v13.x API reference (React 18+) — sync render, queries, userEvent, fireEvent, matchers, renderHook, config.
---

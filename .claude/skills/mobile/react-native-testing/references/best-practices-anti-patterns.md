---
name: react-native-testing-anti-patterns
description: Common RNTL mistakes and corrections — wrong queries, waitFor misuse, unnecessary act, destructuring, missing await in v14.
---

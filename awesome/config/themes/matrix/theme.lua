-----------------------------------------
-- cyberawesome / matrix theme          --
-- Terminal/hacker inspired: near-black --
-- with phosphor green accents         --
-----------------------------------------
...
local bg_alt = "#0f1a0f"
local fg = "#9fffb0"
local accent1 = "#00ff41" -- matrix green: focus/highlight
local accent2 = "#00b8a9" -- teal green: info/secondary
local accent3 = "#ff3131" -- red: urgent/alert
local border_dim = "#132313"

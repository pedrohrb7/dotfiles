...
local utils = require("configs.widgets.audio.utils")
...
local function INC_VOLUME_CMD(card, device, mixctrl, value_type, step)
	return "pamixer -c " .. card .. " -D " .. device .. " sset " .. mixctrl .. " " .. value_type .. " " .. step .. "%+"
end -- luacheck: ignore
...
local widget_types = {
	icon_and_text = require("configs.widgets.audio.icon-and-text-widget"),
	icon = require("configs.widgets.audio.icon-widget"),
	arc = require("configs.widgets.audio.arc-widget"),
	horizontal_bar = require("configs.widgets.audio.horizontal-bar-widget"),
	vertical_bar = require("configs.widgets.audio.vertical-bar-widget"),
}
local volume = {}
